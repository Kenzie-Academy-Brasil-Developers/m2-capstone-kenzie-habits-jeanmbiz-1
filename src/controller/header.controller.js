...
function fazerHeader() {
  const cabecalhoSuperior = document.querySelector(
    ".cabecalho__superior--perfil"
  );
  ...
  const cabecalhoInferior = document.querySelector(
    ".cabecalho__inferior--foto"
  );

  const imgInferior = document.createElement("img");
  imgInferior.classList.add(
    "foto__perfil",
    "animate__animated",
    "animate__flip"
  );
